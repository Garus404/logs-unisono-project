...
const hardcodedLogs: Partial<LogEntry>[] = [
  ...
  { timestamp: new Date('2024-07-25T17:10:00'), type: 'CHAT', user: findUser('Фёдор Круглов'), details: '[OOC] ахаххахаааахаа' },
  ...
  { timestamp: new Date('2024-07-25T17:10:00'), type: 'RP', user: findUser('Чад Пепел'), details: '[СКО] Образец Ящерица ломает большие ворота к.с Ящерицы 4/5' },
